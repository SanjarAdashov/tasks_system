...
def file_size(value):
    if settings.FILE_SIZE_LIMIT > 0 and value.size > settings.FILE_SIZE_LIMIT:
...
class FileAsset(BaseModel):
    ...
    class EntityTypeContext(models.TextChoices):
        ...
        MEETING_ATTACHMENT = "MEETING_ATTACHMENT"
        PROJECT_ANNOUNCEMENT_ATTACHMENT = "PROJECT_ANNOUNCEMENT_ATTACHMENT"
