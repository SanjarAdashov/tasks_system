    ...
    <>
      {!issue ? (
        ...
        <div className="flex h-full w-full overflow-hidden">
          ...
          <div
            className="gts-glass-task-peek fixed right-0 z-[5] h-full w-full min-w-[300px] border-l border-subtle bg-surface-1 sm:w-1/2 md:relative md:w-1/4 lg:min-w-80 xl:min-w-96"
