    ...
    <>
      ...
      >
        ...
        <Combobox.Options className="fixed z-10">
          <div
            className="gts-glass-popover-surface z-10 my-1 w-48 rounded-sm border border-strong bg-surface-1 py-2.5 text-11 whitespace-nowrap shadow-raised-200 focus:outline-none"
