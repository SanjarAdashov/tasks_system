  ...
  function ProfileSettingsLanguageAndTimezonePreferencesList() {
    ...
    const handleTimezoneChange = async (value: string) => {
      try {
        ...
        setToast({
          ...
          message: t("account_settings.preferences.timezone_updated"),
          type: TOAST_TYPE.SUCCESS,
        });
      } catch (_error) {
        setToast({
          title: t("toast.error"),
          message: t("account_settings.preferences.timezone_update_failed"),
    ...
    const handleLanguageChange = async (value: string) => {
      try {
        ...
        setToast({
          title: t("toast.success"),
          message: t("account_settings.preferences.language_updated"),
          type: TOAST_TYPE.SUCCESS,
        });
      } catch (_error) {
        setToast({
          title: t("toast.error"),
          message: t("account_settings.preferences.language_update_failed"),
          type: TOAST_TYPE.ERROR,
        });
      }
    };
    ...
    return (
      <div className="flex flex-col gap-y-1">
            ...
            <CustomSelect
              ...
              label={
                profile?.language
                  ...
                  : t("account_settings.preferences.select_language")
              }
        ...
        <StartOfWeekPreference
          option={{
            title: t("account_settings.preferences.first_day_of_week"),
            description: t("account_settings.preferences.first_day_of_week_description"),
          }}
        />
      </div>
    );
