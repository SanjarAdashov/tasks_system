...
export const StateOrderProjectSettingsHeader = observer(function StateOrderProjectSettingsHeader() {
  const { t } = useTranslation();
  const settingsDetails = PROJECT_SETTINGS.state_order;
  const Icon = PROJECT_SETTINGS_ICONS.state_order;
