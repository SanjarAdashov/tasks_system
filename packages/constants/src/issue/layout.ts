...
export const ISSUE_LAYOUT_MAP: TIssueLayoutMap = {
  ...
  [EIssueLayoutTypes.CUSTOM_GROUPING]: {
    key: EIssueLayoutTypes.CUSTOM_GROUPING,
    i18n_title: "issue.layouts.title.custom_grouping",
    i18n_label: "issue.layouts.custom_grouping",
  },
};
