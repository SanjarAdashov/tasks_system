...
export const TopNavPowerK = observer(() => {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div
        className={cn(
          "gts-glass-popover-surface shadow-lg absolute -top-[6px] left-1/2 z-20 flex -translate-x-1/2 flex-col overflow-hidden rounded-md border border-subtle bg-surface-1 px-0 pt-10 transition-all duration-300 ease-in-out",
          {
