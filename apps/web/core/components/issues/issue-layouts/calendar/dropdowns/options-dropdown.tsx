          ...
          >
            <Popover.Panel className="fixed z-50">
              <div
                ...
                style={styles.popper}
                {...attributes.popper}
                className="gts-glass-popover-surface absolute right-0 z-10 mt-1 min-w-[12rem] overflow-hidden rounded-sm border border-subtle bg-surface-1 p-1 shadow-raised-200"
              >
                <div>
