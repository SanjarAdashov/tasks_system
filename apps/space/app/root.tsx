...
const APP_TITLE = "GTS Task System | Public tasks and requests";
const APP_DESCRIPTION = "Public tasks and request forms powered by GTS Task System.";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "https://tasks.globaltravel.space/spaces/" },
  {
    name: "keywords",
    content:
