...
export const AttachmentProjectSettingsHeader = observer(function AttachmentProjectSettingsHeader() {
  const { t } = useTranslation();
  const settingsDetails = PROJECT_SETTINGS.attachments;
  const Icon = PROJECT_SETTINGS_ICONS.attachments;
