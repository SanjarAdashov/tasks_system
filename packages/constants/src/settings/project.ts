...
export const PROJECT_SETTINGS: Record<TProjectSettingsTabs, TProjectSettingsItem> = {
  ...
  user_groups: {
    key: "user_groups",
    i18n_label: "project_settings.user_groups.label",
    href: `/user-groups`,
    access: [EUserProjectRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/user-groups/`,
  },
  features_cycles: {
    key: "features_cycles",
  ...
  state_order: {
    key: "state_order",
    i18n_label: "project_settings.state_order.label",
    href: `/state-order`,
    access: [EUserProjectRoles.ADMIN],
  ...
  work_item_fields: {
    key: "work_item_fields",
    i18n_label: "project_settings.work_item_fields.label",
    href: `/work-item-fields`,
    access: [EUserProjectRoles.ADMIN],
  ...
  announcements: {
    key: "announcements",
    i18n_label: "project_settings.announcements.label",
    href: `/announcements`,
    access: [EUserProjectRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/announcements/`,
  },
  automations: {
    key: "automations",
...
export const GROUPED_PROJECT_SETTINGS: Record<PROJECT_SETTINGS_CATEGORY, TProjectSettingsItem[]> = {
  ...
  [PROJECT_SETTINGS_CATEGORY.EXECUTION]: [
    PROJECT_SETTINGS["attachments"],
    PROJECT_SETTINGS["announcements"],
