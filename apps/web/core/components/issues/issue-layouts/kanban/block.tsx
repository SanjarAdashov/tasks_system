    ...
    <>
      ...
      >
        <ControlLink
          ...
          ref={cardRef}
          className={cn(
            "gts-glass-kanban-card block w-full rounded-lg border border-subtle bg-layer-2 p-3 text-13 shadow-raised-100 outline-[0.5px] outline-transparent transition-all hover:border-strong hover:shadow-raised-200",
